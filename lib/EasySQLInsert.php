...
/**
 * Class making it very easy to do "INSERT" queries.
 */
class EasySQLInsert extends EasySQLBase
{
    ...
    /**
     * "INSERT" query execution the easy way :-).
     * 
     *     /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
     *     // Typical usage
     *     /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
     *     //    
     *     //    // Do the insert query the easy way :-)
     *     //    $query = "INSERT INTO t_demo ( quand, blabla ) VALUES ( NOW(), '###1###' )";
     *     //    $jsonAnswer = SQLInsert::execute( array(
     *     //                'request' => array(
     ...
     *     //                            'replace-by'  => $jsonReceived[ 'blabla' ],        // Replacement value
     ...
     *     //    
     *     //    
     *     //    // In case the INSERT request execution succeeded
     *     //    return array(
     *     //        'succeeded'    => true,
     *     //        'created-pk'   => (int) the pk of the newly created record,
     *     //        'error'        => null
     *     //    );
     *     //    
     *     //    // In case the INSERT request execution failed
     *     //    return array(
     *     //        'succeeded'        => false,
     *     //        'created-pk'       => null,
     *     //        'error'  => array(
     ...
     * @return array|null the json answer containing the execution 'status' and newly created primary key if desired
    ...
    public static function execute( $execParms ) : array|null {
        ...
        if ( ( $result = mysqli_query( $execParms[ 'request' ][ 'connect' ], $sqlRequest ) ) ) {
            ...
            $justCreatedPK = mysqli_insert_id( $execParms[ 'request' ][ 'connect' ] );

            // Produce final result
            $jsonAnswer = array(
                'succeeded'  => true,
                'created-pk' => $justCreatedPK,
                'error'      => null
            );
